...
function Login() {
  ...
  <h6 style={{color:'black',fontSize:'12px'}}>Don't have an account?<button style={{border:'none',backgroundColor:'transparent'}} onClick={signup}><span className="text-decoration-underline" >Create Account</span></button></h6>
