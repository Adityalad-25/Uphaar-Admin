...
function FireStation() {
  ...
  const { fireStations, fetchAllFireStation, addFireStation, updateFireStation, deleteFirestation } = cxt
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              ...
              <button type="button" ref={closeAddRef} className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form onSubmit={submitNewFireStation} >
          ...
          <div className="modal-content">
            ...
            <form onSubmit={submitEditfireStation} >
              <div className="modal-body">
                ...
                <div className="mb-3" style={{ textAlign: 'left' }}>
                  <label htmlFor="fname" className="form-label">Name</label>
                  <input type="name" onChange={editHandleChange} required className="form-control" name="fname" value={editFireStation.fname} id="fname" />
                </div>
                <div className="mb-3" style={{ textAlign: 'left' }}>
                  <label htmlFor="faddress" className="form-label">Address</label>
                  <input type="text" onChange={editHandleChange} required className="form-control" id="faddress" name="faddress" value={editFireStation.faddress} />
                </div>
                <div className="row mt-2">
                  <div className="col">
                    <input type="text" id="fcity" onChange={editHandleChange} required className="form-control" value={editFireStation.fcity} placeholder="City" />
                  </div>
                  <div className="col">
                    <input type="text" id="fstate" onChange={editHandleChange} required className="form-control" value={editFireStation.fstate} placeholder="State" />
                  </div>
                </div>
                <div className="row mt-2">
                  <div className="col">
                    <input type="text" id="flat" onChange={editHandleChange} required className="form-control" value={editFireStation.flat} placeholder="Latitude" />
                  </div>
                  <div className="col">
                    <input type="text" id="flong" onChange={editHandleChange} required className="form-control" value={editFireStation.flong} placeholder="Longitude" />
                  </div>
                </div>
                <div className="row mt-2">
                  <div className="col">
                    <input type="text" id="fpincode" onChange={editHandleChange} required className="form-control" value={editFireStation.fpincode} placeholder="Pincode" />
                  </div>
                  <div className="col">
                    <input type="text" id="fphone" onChange={editHandleChange} required className="form-control" value={editFireStation.fphone} placeholder="Phone" />
                  </div>
                </div>
              </div>
              <div className="modal-footer">
